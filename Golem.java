...
public class Golem extends Creature
{
    ...
    /**
     * attackAnimtion hasn't changed from charmander
    ...
    /**
     * 
     * switchCreature is also the same from charmander
     * @param there is an idx parameter
     * @return still doesn't return anything
     */
    ...
    /**
     * wouldn't you know? it's the same!! it literally says copy all the stuff from charmander
     * switchedIn controls the speed at which Golem switches
     * @param there are no parameters
     * @return there are no returns
     */
