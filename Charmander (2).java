...
public class Charmander extends Creature
{
    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if(enemyType.equalsIgnoreCase("Water"))
            {
                ...
                getWorld().showText("It wasn't very effective",getWorld().getWidth()/2, getWorld().getHeight()/2);
                Greenfoot.delay(30);
            }
            else
            {
    ...
    public void switchCreature(int idx)
    {
        ...
        {
            JOptionPane.showMessageDialog(null, "Pokemon has fainted please choose another");
        }
        else 
        {
            while(getX() > 0)
