...
public class Pikachu extends Creature
{
     ...
     */
    /**
     * who would have thought that this still hasn't changed from Charmander
    ...
    /**
     * switchCreature switches some Pokemon™️(spent 5 mins on the tm) through coding mojo
     * @param there is yet another idx parameter
     * @return there are no returns
     */
     ...
     */
    /**
     * switchedIn tells this one to hide or something
     * @param there are no parameters
     * @return there are returns
     */
