...
public class Charmander extends Creature
{
    ...
    //TODO 33
    /**
     * attackAnimations controls the movement for charmander... well, attack Animations
     ...
     * 
     * TODO (48): Declare a local Creature variable called switchCreature
     * 
     *          
    ...
    //TODO 46
    /**
     * switchCreature tells charmander how to act when he's told to switch
     * @param theres and idx parameter which is supposedly an int but I don't know what it does
    ...
    /**
     * switchedIn tells charmander to basically hide charmander when he's switched out
     * @param there are no parameters
     * @return there is no returns
     */
